...
% Section Titles Styling (IEEEtran-like)
\titleformat{\section}{\bfseries\large\scshape\centering}{\thesection.}{0.5em}{}
\titleformat{\subsection}{\bfseries\itshape}{\thesubsection.}{0.5em}{}
\titleformat{\subsubsection}{\itshape}{\thesubsubsection.}{0.5em}{}

\title{\textbf{\Large Federated GAT-Twin: A Privacy-Preserving Cyber-Physical Framework for Resilient Smart Grid Anomaly Detection and Localization}}
\author{
    \textbf{Avijit Baidya} \\
    \small Department of Electrical Engineering \\
    \small \textit{Grid Security Research Initiative} \\
    \small Email: avijit.baidya@ieee.org
}
\date{}
